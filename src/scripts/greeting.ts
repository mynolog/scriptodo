const nameForm = document.querySelector<HTMLFormElement>('.js-nameForm')!
const input = nameForm.querySelector<HTMLInputElement>('input')!
const greeting = document.querySelector<HTMLHeadingElement>('.js-greetings')!
...
const paintGreeting = (userName: string) => {
